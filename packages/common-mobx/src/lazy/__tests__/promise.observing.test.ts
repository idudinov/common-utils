...
import { createObservingExtension, LazyPromiseObservable } from '../observable.js';

describe('LazyPromise observing extension', () => {
    ...
    test('observing: continues after factory error', async () => {
        ...
        try {
            ...
            expect((lazy.error as Error).message).toBe('Fail');
